    ...
    <script>
        function showBook(str) {
            if (str.length == 0) {
                ...
                document.getElementById("pnl-result").style.display = "block"; // Show default/filter table
                return;
            } else {
                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        document.getElementById("pnl-result").style.display = "none"; // Hide default/filter table
                    }
                };
...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">ECS BMDB</a>
        </div>
